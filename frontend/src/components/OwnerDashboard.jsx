  ...
  return (
    <div className='w-full min-h-screen flex flex-col items-center px-5 py-8'>
      ...
      <div className='flex justify-center p-4 sm:p-6'>
        <div className='w-full max-w-md bg-white shadow-lg rounded-2xl p-6 border border-gray-100 hover:shadow-xl transition-shadow duration-300'>
          <div className='flex flex-col items-center text-center'>
            ...
            <button className='bg-[#7F00FF] text-white px-5 sm:px-6 py-2 rounded-full font-medium shadow-md hover:bg-[#6500CC] transition-colors duration-200' onClick={()=>navigate('/create-edit-shop')}>Get Started</button>
          </div>
        </div>
      ...
      <div className='w-full flex flex-col items-center gap-6 px-4 sm:px-6' >
        <h1 className='text-2xl sm:text-3xl text-gray-900 flex items-center gap-3 mt-8 text-center'><FaUtensils className='text-[#7F00FF] w-14 h-14'/>Welcome to {myShopData.name}</h1>
        <div className='bg-white shadow-lg rounded-xl overflow-hidden border-orange-100 hover:shadow-2xl transition-all duration-300 w-full max-w-3xl relative'>
          <div className='absolute top-4 right-4 bg-[#7F00FF] text-white p-2 rounded-full shadow-md hover:bg-[#6500CC] transition-colors cursor-pointer' onClick={()=>navigate("/create-edit-shop")}>
             <FaPen size={20}/>
          </div>
        ...
        <div className='w-full max-w-md bg-white shadow-lg rounded-2xl p-6 border border-gray-100 hover:shadow-xl transition-shadow duration-300'>
          <div className='flex flex-col items-center text-center'>
            ...
            <button className='bg-[#7F00FF] text-white px-5 sm:px-6 py-2 rounded-full font-medium shadow-md hover:bg-[#6500CC] transition-colors duration-200' onClick={()=>navigate('/add-item')}>Add Food</button>
          </div>
        </div>
      </div>
          }
